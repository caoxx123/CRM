package com.smartdot.controller;
...
import com.smartdot.entity.PageBean;
import com.smartdot.entity.User;
import com.smartdot.service.UserService;
import com.smartdot.util.ResponseUtil;
import com.smartdot.util.StringUtil;
...
public class UserController {
	...
	public String login(User user,HttpServletRequest request)throws Exception{
		...
		if(resultUser==null){
			...
			if(resultUser!=null){
				if(resultUser.getRoleName().equals("高管")){
					return "redirect:/main.jsp";
				}
				if(resultUser.getRoleName().equals("系统管理员")){
					return "redirect:/main1.jsp";
				}
				if(resultUser.getRoleName().equals("客户经理")){
					return "redirect:/main2.jsp";
				}
				if(resultUser.getRoleName().equals("销售主管")){
					return "redirect:/main3.jsp";
				}
			}else{
